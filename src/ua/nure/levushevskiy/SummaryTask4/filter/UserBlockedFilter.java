...
/**
 * A filter that monitors the status of the user.
 */
@WebFilter(filterName = "UserBlockedFilter",
        urlPatterns = {"/*"})
public class UserBlockedFilter implements Filter {

    /**
     * The Logger object for logging events of filter class.
     */
    private static final Logger LOG = Logger.getLogger(UserBlockedFilter.class);

    /**
     * Possible mapping for a blocked user.
     */
    private static final String EXCLUDE_MAPPING = "/logOut";

    @Override
    public final void init(final FilterConfig filterConfig) throws ServletException {
        LOG.debug("UserBlockedFilter started");
    }
    ...
    public final void destroy() {
        LOG.debug("UserBlockedFilter finished");
    }
